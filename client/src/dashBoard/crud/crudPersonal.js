...
import AddForm from "../../form/personal/addForm";
import DeleteForm from "../../form/personal/deleteForm";
import EditForm from "../../form/personal/editForm";
    ...
    <section className="Competence">
      <div className="blockCRUD">
        ...
        <div className="Liste">
          ...
          <div>
            {data.map((item) => (
              <div key={item.id_personal} className="blockListe">
                <p>{item.title}</p>
                <p>
