...
import AddForm from "../../form/career/addForm";
import DeleteForm from "../../form/career/deleteForm";
import EditForm from "../../form/career/editForm";
      ...
      <div className="blockCRUD">
        <div className="CRUD">
          <div className="buttonCrud">
            <button onClick={OpenAddForm}>Add a Career</button>
            <button onClick={OpenEditForm}>Edit a Career</button>
            <button onClick={OpenDeleteForm}>Delete a Career</button>
          </div>
          {showAddForm && <AddForm />}
        ...
        <div className="Liste">
          ...
          <div>
            {data.map((item) => (
              <div key={item.id_career} className="blockListe">
                <p>{item.title}</p>
                <p>
