...
import AddForm from "../../form/frontEnd/addForm";
import DeleteForm from "../../form/frontEnd/deleteForm";
import EditForm from "../../form/frontEnd/editForm";
      ...
      <div className="blockCRUD">
        <div className="CRUD">
          <div className="buttonCrud">
            <button onClick={OpenAddForm}>Add a FrontEnd</button>
            <button onClick={OpenEditForm}>Edit a FrontEnd</button>
            <button onClick={OpenDeleteForm}>Delete a FrontEnd</button>
          </div>
          {showAddForm && <AddForm />}
        ...
        <div className="Liste">
          ...
          <div>
            {data.map((item) => (
              <div key={item.id_front_end} className="blockListe">
                <p>{item.title}</p>
                <p>
